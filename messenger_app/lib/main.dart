...
import 'package:messenger_app/pages/chats_page/bloc/current_message_bloc/curren_message_cubit.dart';
  ...
  runApp(
    MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (_) => InputFieldCubit()),
        BlocProvider(create: (_) => ChatCubit()),
        BlocProvider(create: (_) => CurrenMessageCubit()),
      ],
